...
<body>
	...
	<div class="innerOuter">
		...
		<button class="btn btn-lg btn-danger" onclick="findServiceAreaFoods();">휴게소 검색하기</button>	
		...
		<button class="btn btn-lg btn-primary" onclick="findServiceArea();">휴게소 음식 검색하기</button>
	...
	<script>
		...
		function findServiceAreaFoods() {
			...
			// const line = document.querySelector("").innerText;
