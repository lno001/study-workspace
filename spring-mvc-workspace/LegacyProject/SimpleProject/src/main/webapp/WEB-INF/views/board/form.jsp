            ...
            <form id="enrollForm" method="post" action="/spring/boards" enctype="multipart/form-data">
                <table style="align : center;">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="writer" class="form-control" value="${ userInfo.userId }" name="boardWriter" readonly></td>
                    </tr>
                    <tr>
   ...
   <script>
                	function changeImage(file){
                		...
                		if(file.files.length){ 
                			...
                			const img = 'https://kh-academy.co.kr/resources/images/main/logo.svg';
                			imgEl.src = img;
                		}
                	}
                </script>
