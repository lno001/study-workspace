    ...
    <div id="header">
        <div id="header_1">
            <div id="header_1_left">
                <img src="https://i.namu.wiki/i/0ItWBzNAYoqx-saiUREAs__NcaMDLEYryE7qfZ19SFCvC5fFiintS8g0zy9CXvryQytwv_MjNfAQCZ7xJPK8QnQwnx_5gJw6G78s1IEJRdvGQMbbqeQg03b2RgAE-_h6K6IPMe5E1LgGzJy5Sk7PVg.webp" alt="">
            </div>
        ...
        <div id="header_2">
            <ul>
                <li><a href="/lim">HOME</a></li>
                <li><a href="">공지사항</a></li>
                <li><a href="/lim/charaboards">캐릭터게시판</a></li>
